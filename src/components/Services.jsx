...
const SERVICES = [
  {
    ...
    desc: "Authentic South Indian weddings — from banana leaf mandapas and jasmine garlands to every Vedic ritual performed with sacred precision.",
    highlights: ["Muhurtham planning", "Mandapa & floral décor", "Full ritual management", "Catering coordination"],
  ...
  },
  {
    ...
    title: "Upanayana",
    kannada: "ಉಪನಯನ",
    desc: "Sacred thread ceremony managed with complete Vedic attention — every detail, every sloka, reverently handled.",
  ...
  {
    icon: "🌸",
    title: "Floral & Eco-Friendly Décor",
    kannada: "ಹೂ ಮತ್ತು ಪರಿಸರ ಸ್ನೇಹಿ ಅಲಂಕಾರ",
    desc: "Zero-plastic, nature-first décor — fresh marigolds, jasmine, banana leaves, sugarcane pillars, clay diyas. Beautiful and responsible.",
    highlights: ["Marigold & jasmine themes", "Banana leaf arrangements", "Clay diya lighting", "Zero plastic"],
