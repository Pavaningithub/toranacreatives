      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-cream/70 font-sans text-sm sm:text-base leading-relaxed">
              Our team of event planners, floral artists, and Vedic ritual coordinators specialises in the full spectrum of South Indian ceremonies — from intimate Gruhapravesha blessings to grand multi-day weddings across Bengaluru, Mysuru, and beyond.
            </p>
            <p className="text-cream/70 font-sans text-sm sm:text-base leading-relaxed">
